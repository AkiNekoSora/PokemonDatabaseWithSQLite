...
This is the Main Project for Software Development I. I decided to create a Pokémon Database. During this Module, I built a SQLite database and allows the user to choose what database to use. It does require specific tables and columns so you can find the example database in the main folder.
